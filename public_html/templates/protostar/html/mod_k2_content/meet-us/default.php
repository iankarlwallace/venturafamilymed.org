...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlockMeetUs<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "oddMeetus" : "evenMeetus"; if(count($items)==$key+1) echo ' lastItemMeetus'; ?>">
      ...
      <?php if($params->get('itemAttachments') && count($item->attachments)): ?>
			...
			<ul class="moduleAttachmentsList">
