...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlockRot<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">

	<?php if($params->get('itemPreText')): ?>
	<p class="modulePretextRot"><?php echo $params->get('itemPreText'); ?></p>
	<?php endif; ?>
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <a class="moduleItemTitleRot" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
      <?php endif; ?>
      ...
      <?php if($params->get('itemAttachments') && count($item->attachments)): ?>
			<ul class="moduleAttachments">
				<?php foreach ($item->attachments as $attachment): ?>
				<li><a title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>" href="<?php echo $attachment->link; ?>"><?php echo $attachment->title; ?></a></li>
				<?php endforeach; ?>
			</ul>
      <?php endif; ?>
  ...
  <?php endif; ?>
	...
	<a class="moduleCustomLinkRot" href="<?php echo $params->get('itemCustomLinkURL'); ?>" title="<?php echo K2HelperUtilities::cleanHtml($itemCustomLinkTitle); ?>"><?php echo $itemCustomLinkTitle; ?></a>
	<?php endif; ?>
