...
<?php if(isset($this->item->editLink)): ?>
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlockFront">
		  <span class="itemImageFront">
	...
	<?php if($this->item->params->get('itemGooglePlusOneButton',1)): ?>
		...
		<div class="fb-follow" data-href="https://www.facebook.com/venturafamilymed" data-colorscheme="light" data-layout="button_count" data-show-faces="true" ></div>

		</div>
		<div class="itemFacebookButton">
			<div class="fb-like" data-href="http://www.venturafamilymed.org" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
		</div>
		<?php endif; ?>
...
-->
   ...
   $('ul.nav-pills > li.parent').addClass('dropdown');
   ...
   $('ul.nav-pills > li.parent > a').addClass('dropdown-toggle').attr('data-toggle', 'dropdown');
   // adds dropdown-menu to the first dropdown (basically the whole first menu)
   $('ul.nav-pills > li.parent > ul.nav-child').addClass('dropdown-menu');
